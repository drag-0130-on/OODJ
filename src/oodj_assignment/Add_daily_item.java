 ...
 * @author Lenovo
 */
public class Add_daily_item extends javax.swing.JFrame {

    /**
     * Creates new form Add_daily_item
     */
    public Add_daily_item() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_daily_item.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_daily_item().setVisible(true);
            }
        });
    }
