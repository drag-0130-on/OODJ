 ...
 * @author drag0
 */
public class PM_PO extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PM_PO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
