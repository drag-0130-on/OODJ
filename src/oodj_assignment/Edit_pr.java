 ...
 * @author Lenovo
 */
public class Edit_pr extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_pr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
